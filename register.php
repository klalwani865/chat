...
if(isset($_POST["register"]))
{
    ...
    else
    {
        if($user_object->save_data())
        {
            ...
            $mail->Username   = 'klalwani865@gmail.com';                     // SMTP username
            $mail->Password   = 'keql bmfk aujh vldu';

            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;

            $mail->Port = 587;

            $mail->setFrom('klalwani865@gmail.com');
            ...
            <p>Thank you for registering for Chat Application Demo.</p>
                ...
                <p><a href="http://localhost:80/chat/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
                <p>Thank you...</p>
            ';
